                    ...
                    <div class="a-row a-spacing-base" v-for="product in getCart" :key="product._id">
                      <div class="row">
                        ...
                        <div class="col-sm-9 col-9">
                          ...
                          <div class="a-row">
                            <span class="availability a-color-success">In Stock.{{ product.stockQuantity }}</span>
                          </div>
                          <div class="a-row">
                            <!-- Product's quantity -->
                ...
                <div class="a-row">
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">USD {{  shipmentPrice }}</div>
                    </div>
                    <div class="row mt-2">
...
export default {
  ...
  async asyncData({ $axios, store }) {
   ...
   computed: {
      ...mapGetters(["getCart", "getCartTotalPrice","getCartLength","getCartTotalPriceWithShipping"])
    },
};
</script>